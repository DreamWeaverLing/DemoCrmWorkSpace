...
<script>
	$(function (){
		...
		// 保存交易
		$("#saveTransactionBtn").click(saveTransaction)
	})
...
<%--							<tr>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;" id="saveTransactionForm" action="workbench/transaction/saveTransaction.do" method="post">
