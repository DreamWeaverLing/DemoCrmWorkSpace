...
<%--<script type="text/javascript" src="workbench/activity/indexjs.jsp"></script>--%>
<script>
    //默认情况下取消和保存按钮是隐藏的
    ...
    $(function () {
        ...
        $("#updateRemarkBtn").on("click", updateRemark)
        $("#saveReamrkBtn").on("click", saveRemark)
        $("#editActivityBtn").on("click",editActivity)
        $("#deleteActivityBtn").on("click",deleteActivity)
    });
    ...
    function showRemarkList() {
        $.ajax({
            dataType: "json",
            url: "workbench/activity/getDetailRemarks.do",
            type: "get",
            data: {"id": "${activity.id}"},
            success: function (data) {
                var html = ""
		...
		<div id="remarkDiv" style="background-color: #E6E6E6; width: 870px; height: 90px;">
			<form role="form" style="position: relative;top: 10px; left: 10px;">
				...
				<p id="cancelAndSaveBtn" style="position: relative;left: 737px; top: 10px; display: none;">
					...
					<button type="button" class="btn btn-primary" id="saveReamrkBtn">保存</button>
				</p>
			</form>
		</div>
	</div>
